...
// Brand-aligned: electric blue glow (Pixxel primary) instead of the demo purple.
const DEFAULT_PARTICLE_COUNT = 12;
const DEFAULT_SPOTLIGHT_RADIUS = 300;
const DEFAULT_GLOW_COLOR = '3, 212, 255';
const MOBILE_BREAKPOINT = 768;

// Customer Passport dashboard tiles (replaces the generic demo cards).
const cardData = [
  { color: '#0E121B', title: 'Active passports', description: 'Live deals across all six industries', label: 'Pipeline' },
  { color: '#0E121B', title: 'Quality checks', description: 'Images QC’d this week · awaiting review', label: 'This week' },
  { color: '#0E121B', title: 'Feasibility studies', description: 'Generated from the feasibility tool', label: 'Feasibility' },
  { color: '#0E121B', title: 'AOI library', description: 'Areas of interest stored & re-usable', label: 'Maps' },
  { color: '#0E121B', title: 'Team activity', description: 'Sales, SE, CS & Analytics — last 24h', label: 'Team' },
  { color: '#0E121B', title: 'MVP images', description: 'Flagged customer-ready captures', label: 'Highlights' }
];
